...
The codebase analysis (1.5) examines your existing code for patterns, integrations, and constraints. This informs the specification.
...
The requirements lock is the authoritative reference for Dev and QA. It contains:
...
For unclear requirements, PM can invoke brainstorming:

```bash
/sf:brainstorm "how should we handle user onboarding?"
```

This produces structured ideation using 60+ brainstorming techniques.

### UX Design

For UI-heavy features, PM routes to UX analysis:

```bash
/sf:ux "design the checkout flow"
```

This produces UX recommendations that inform architecture.
...
This generates Excalidraw JSON from architecture documents.
