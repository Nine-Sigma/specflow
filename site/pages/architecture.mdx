...
SpecFlow syncs with external trackers to create tickets from generated stories:
...
The `/sf:scrum` command manages this integration:
...
Sprint boards show real-time status:
...
7. **Tracker integration**: Sync with GitHub, Jira, Linear
