...
- **Conversational validation**: `/gsd:verify-work` enables structured acceptance testing
- **Goal-backward verification**: Verifier checks actual codebase against phase goals
