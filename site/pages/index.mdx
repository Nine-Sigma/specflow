---
description: SpecFlow is a PM-orchestrated, security-first, cost-aware, test-driven AI development methodology with automated code review, slop detection, and UAT.
---
...
Built on the foundation of the [BMAD Method](https://github.com/bmad-code-org/BMAD-METHOD), SpecFlow delivers the expertise without the complexity. You get rigorous software engineering practices without needing a PhD in each discipline.
...
- [MCP Tools](/mcp-tools) - Direct `specflow_*` tool reference and examples
- [Context Engine](/context-engine) - Scope-tiered context assembly and code intelligence
- [Architecture](/architecture) - PM orchestration and agent flow
- [Methodology](/methodology) - STRIDE, BOSS, TEA, and cost frameworks
- [PMO Reporting Skills](/reporting-skills) - Executive reporting, health checks, RAID, and decks
